...
import io.github.nayetdet.gamekube.payload.request.GameHeartbeatRequest;
...
public class GameWebSocketController {
  ...
  public void heartbeat(Principal principal, @Payload @Valid GameHeartbeatRequest request) {
    if (principal == null) {
