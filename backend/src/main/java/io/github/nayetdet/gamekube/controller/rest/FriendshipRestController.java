...
public class FriendshipRestController implements FriendshipRestControllerDocs {
  ...
  public ResponseEntity<FriendshipResponse> create(
      @RequestBody @Valid FriendshipRequestPayload payload, Principal principal) {
  ...
  public ResponseEntity<FriendshipResponse> update(
      ...
      @RequestBody @Valid FriendshipStatusRequest request,
      Principal principal) {
    return ResponseEntity.ok(
        friendshipService.update(principal.getName(), id, request.getStatus()));
  }
  ...
  public ResponseEntity<Void> delete(@PathVariable String username, Principal principal) {
    friendshipService.delete(principal.getName(), username);
